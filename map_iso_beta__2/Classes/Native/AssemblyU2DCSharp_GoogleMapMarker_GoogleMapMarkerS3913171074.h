...
struct  GoogleMapMarkerSize_t3913171074 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(GoogleMapMarkerSize_t3913171074, ___value___1)); }
